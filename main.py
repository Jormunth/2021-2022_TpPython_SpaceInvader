...
from player import Missile, Vaisseau, MissileVaisseau, MissileAlien, Bloc
...
def keyDown(event):
    #fonction qui se déclenche lors de l'appuie d'une touche et qui permet de 
    #tirer et déplacer le vaisseaux
